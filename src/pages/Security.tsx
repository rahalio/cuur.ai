  ...
  return (
    <div className="min-h-screen pt-32 bg-gradient-to-b from-blue-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-5xl font-bold text-center mb-8">Security & Privacy</h1>
          <p className="text-2xl text-gray-600 text-center mb-16 max-w-3xl mx-auto">
            Enterprise-grade security and HIPAA compliance to protect sensitive medical data.
          </p>
        </motion.div>
